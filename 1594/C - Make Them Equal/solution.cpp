...
// ------------------------- Main Logic ------------------------- //
/*
i was getting wa last time so now lets do it again
if all letters present ans is 0 very easy
i%x!=0 , so suppose last char matches , then we can 
always say like x=last digit , so ans=1 as i%(something greater than i)!=0
suppose last digit doesnt match , and if we check 2ndlast it matches
then also ans can be 1 as we take 2nd last
like there cant be case suppse 2,b , aa here coz we would never get an answer
now what if both last and 2nd last not matches now can we get ans in 1??
like suppose ddddxy ,d,  here i can chosex=4 co 5%4!=0 && 6%4!=0
what if it was dxy, d , here we would have to take last and 2nd last
coz d=1 , and anything %1==0
so like from end <n/2 digit matches then answer is 1 
otherwise it has to be 2 ig
// aaacd
 
 
*/

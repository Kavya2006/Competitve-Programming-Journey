...
ll n=s.length();
// hi
// so for first position and second positions b cannot come as repition
// so we let first choice be 26 then 25 , then 25 , so answer=76
// but if hh , then first choice 26 then 25 and yeah 25 same answer
cout<<n*25+26<<endl;
 
}
 

...
ll n,k ; cin>>n>>k;
/*
need ones from 1 then 1+k ....
and from n then n-k then n-2k and so on
till they overlap or cross each other
suppose n=11 and k=4
so 1 5 9 
11 7 3
so we have 10001010001
4 is the answer
here answer is like coming 2*(n/k)=4
 
now n=12 and k=4
1 5 9
12 8 4
still same answer =4 but 2*n/4 not working
so what if 2*(ceil(n/k)-1) =4 in both two
 
now n=13 and k=4
1 5 9 13
13 9 5 1
here 1000100010001
but here not working idk
 
 
distance between any two ones at max k
so no of intervals of k in n
first=1;
last=n;
n-1
 

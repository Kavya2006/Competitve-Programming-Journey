...
// ------------------------- Main Logic ------------------------- //
/*
suppose i have a1,a2,a3
a1&a2 we find
a1|a2 we find
a1+a2=a1&a2+a1|a2
then find a2+a3
then find a1+a3
then just 3eq 3 variable easy
 
 
*/
 
void Solve() {
   ...
   cin>>t2;
   b1=t1+t2;
   cout<<"or 3 2"<<endl<<flush;
   cin>>t1;
   cout<<"and 3 2"<<endl<<flush;
   cin>>t2;
   b2=t1+t2;
...
 
   */
   for(ll i=0; i<n-3; i++){
    ll x,y;
    cout<<"or "<<1<<" "<<i+4<<endl<<flush;
    cin>>x;
    cout<<"and "<<1<<" "<<i+4<<endl<<flush;
    cin>>y;
    a[i+3]=x+y-a1;
   }
   sort(a.begin(),a.end());

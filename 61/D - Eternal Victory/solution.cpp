...
// so x is like furthest point from 1
// so we have to go from 1 to x and all paths which come in between visit them twice
// suppose we have total path length , then ans can be 2*(total-dis[x])+dis[x]
// 2*total-dis[x] ,
cout<<2*total-dis[x]<<endl;
 
 
 
 

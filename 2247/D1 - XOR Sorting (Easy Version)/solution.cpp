...
16,17,18,19,20,21
 
suppose go from 24 to 23
24^23=15
24 xor 16=8
and 16^23=7 , so i can go in 8 at min if i wanted to
its coz when taking their xor
16,16 bits gets cancelled , so remaining bits left
so to minimise it i just go from 24 to 16
then 16,23 take
24=11000
23=10111
xor gives 1111 which is 15
 
 
 
*/

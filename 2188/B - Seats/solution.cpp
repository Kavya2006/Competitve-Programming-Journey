...
for(ll i=0 ; i<consecutive.size(); i++ ){
    
    initial+=consecutive[i]/3;
}
if(leftcount>=2){
    if(leftcount%3==0 || leftcount%3==1){
        initial+=leftcount/3;
    }
    else{
        initial+=leftcount/3+1;
    }
}
if(rightcount>=2){
    if(rightcount%3==0 || rightcount%3==1){
        initial+=rightcount/3;
    }
    else{
        initial+=rightcount/3+1;
    }
}
 
cout<<initial<<endl;

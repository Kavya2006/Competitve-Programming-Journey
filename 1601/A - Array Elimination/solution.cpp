...
/*
13 7 25 19
01101 ,00111, 11001,10011
so 1s bit at first=4
1s bit at 2nd=2
1s bit at 3rd=2
1s bit at 4th=2
so we can make all indiv or pairs of 2 to remove bits
as all %2==0
 
if they were like 4,3,2,2 something like this
then gcd of all is 1 so ans would have been 1
but what if all were like 4,4,4,4
so gcd of all of them is 4 , so it will be factors of 4
 
if all zeroes , like 0,0,0,0.. gcd=0 , so here ans=1,2,3,4,5
like only when all numbers zero zero
 
*/
 
 

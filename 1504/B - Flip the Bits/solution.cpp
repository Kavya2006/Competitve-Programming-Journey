...
// ------------------------- Main Logic ------------------------- //
/*
so no of 1 in a should be equal to no of 1 in b
otherwise its not possible
 
suppose 12
010101010101
100110011010
so like wherever character does not match that should be taken in prefix
so here i can start from last 1,0 does not match
so we have to take full string a and convert it
if conversion not possible then ans is no
here it is so ans is yes
 
now here 
6
000111
110100
here 1,0 not match  , move left and take this 
then 1,0 not match , move left and take this
1,1 matches so now we have to try to take prefix here also after doing 1st op
otherwise it wont be possible
after doing 1st op a=111000
                   b=110100
  now we have to take 0,1 here but no of zero!=no of 1 for this to take so ans=0
so i have to implemenet something like this 
 
 
 
*/

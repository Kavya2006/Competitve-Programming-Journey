...
/*
now lets think
first we see a[0] and a[2] if diff <=d then a[3] if still then continue
if a[l] doesnt have , so now we have l-1-0+1= l possible 
now see a[1] and start from a[l].. techincally we are continuing so t.c here
should be o(n) ig lets try to implement
 
*/
 
ll b=2;

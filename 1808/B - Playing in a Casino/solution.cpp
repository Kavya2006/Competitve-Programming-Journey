...
// ------------------------- Main Logic ------------------------- //
/*
so suppose i have cards 1,1,3,4
i have to find all in o(4) only so how would i do it
so here answer will be 2+2+1+3+3+0=11
something contribution technique i have to try ig
so what if i go first get 1-1=0 , then go to 3-1=2, but 4 is also ahead
so this contribution will increase so i add remaining numbers also
 
like suppose i have 1,1,3,4,9 something like this
// n=5
so when i go i=1
so ans=(1-1)*(n-i)=0*(4) as 3,4,9 also to contri
then (3-1)*(n-i)*i=2*3*2 so yeah it should work ig
 
*/
 
void Solve() {

...
 
/*
so most optimal will be to best use of i and j 
like to take at all diagonals and one of the other
so 1*1+2*2+3*3+4*4...n*n
// and non diagonals=`1*2+ 2*3 + 3*4... n-1 and so on
so summation i*i + i*(i-1)
== summation 2*i*i-i
 
 
*/

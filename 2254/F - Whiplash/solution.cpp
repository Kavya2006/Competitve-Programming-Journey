...
// ------------------------- Main Logic ------------------------- //
/*
so upto 1e9 all numbers almost
so obv bits something
so n is even its given this
 
1 2 4 7
6 7 5 3
suppose here
...
 
oh i got it ig
if i perform by sleecting indice something and then something
we can basically swap 2 elements
without doing something in other
 
so suppose we have a1,a2,a3,a4
 
if we take i=1
 
...
now i=2
 
a2,a2^a1,a3^a2,a4^a2
 
now i=1
a2,a1,a3,a4
essentially we just swapped 2 elements
So basically we can make any permutation of our choice ig
now what if i do
like a1,a2,a3,a4
i=1 ,i=2
i get
a2,a2^a1,a3^a2,a4^a2
now if i=3
a3,a3^a1,a3^a2,a4^a3
so basically like
we can make any perm
and secondly any perm or all elements except the correct one , get xor with this element thing 
 
 
wait 
thing is 
suppose we have a1,a2,a3,a4
op1 , a1,a2^a1,a3^a1,a4^a1
so basically we can form (Xor of all)^(any one element) this thing
or just xor of all
 
 
 

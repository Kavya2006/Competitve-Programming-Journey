...
 
// ------------------------- Main Logic ------------------------- //
// so basically for all primes
// min we should give to both , 
// also powers of something in x should be greater than or equal to y
// otherwise lcm%hcf!=0 , which would be like wrong
// so like i can basically subtract , and if negative then no
// other multiply with 2^diff to ans , 
 
void Solve() {
    vector<ll>pow;
    pow.assign(1e6,1);

...
// so order of r and b needs to be mantained
// since a1, comes in all after it
// and a2 comes in all after it so we should take maximum
 
 
// na it wont work
// lets take max sum of all elements from start to end of r and similarly for b
// and add those max coz we can take it 
ll max1=0;
ll sum1=0;
for(ll i=0 ; i<n ; i++){
sum1+=r[i];

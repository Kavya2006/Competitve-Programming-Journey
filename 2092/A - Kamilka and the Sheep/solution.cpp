...
sort(a.begin(),a.end());
/* suppose 2 numbers x and y and y>x
so gcd(x+d , y+d)=gcd(x+d,y+d-(x+d))
=gcd(x+d,y-x); // so as d can be any integer and we put it to become a 
multiple of y-x , so gcd max = y-x
*/
cout<<a[n-1]-a[0]<<endl;
 
 

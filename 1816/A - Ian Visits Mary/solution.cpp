...
 
void Solve(){
/* fu*king 4 wrong submissions , lets think again
if gcd is 1 then yes can go directly
if not 1
eg 6 10 .. 
we start at 0,0 , we can go to 5 1 
then like we can consider we are at 0,0 and target is 1,9 so gcd again will be 
1
 
 
*/

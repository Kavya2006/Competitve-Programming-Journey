...
// ------------------------- Main Logic ------------------------- //
/*
so basically if any num subset of other then true
also like a num subset of other like or of 2 or morenumbers then also true
like suppose num is 2,5 and others are 5,8 and 2,4
so or of 5,8 2,4 is 2,4,5,8 and here it can take 2,5
so for a num we basically have to find if all freq of it exists as double
 
*/
 
void Solve() {

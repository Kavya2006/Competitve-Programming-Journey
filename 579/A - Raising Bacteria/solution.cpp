...
// ------------------------- Main Logic ------------------------- //
/*
so if x is like 2^power something , then answer is obv 1
   so suppose i have 18, for it 9 enough
   // for 9 , 4 enough , for 4 nothing
   // so if we cant divide by 2 we add 1 to ans ig

...
void Solve(){
ll l,r; cin>>l>>r;
// so basically if a number dont have 2,3,5,7 in its prime factorisation
// then its good
// so we find total - not good by using principal of inclusion exclusion
 
cout<<goodgetter(r)-goodgetter(l-1)<<endl;
 
 
 
 

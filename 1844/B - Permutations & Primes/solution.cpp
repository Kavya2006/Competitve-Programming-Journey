...
void Solve(){
ll n; cin>>n;
// what about first elemenet 2 and last element 3 for n>=3
// now for only l=1 and r=5 might not be prime
// rest prime
if(n==1){
    cout<<1<<endl;
    return;
...
 
// f , update - 2 one should be in middle so maximum choice otherwise mex becomes 1
 
deque<ll>a;
a.push_back(1);
for(ll i=4 ; i<=n; i++){

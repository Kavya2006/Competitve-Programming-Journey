...
 
// ------------------------- Main Logic ------------------------- //
// lets analyze 1000 case
// so best is 21 21 18 , we can consume all
// and then if 18 left , we use 18,18,18
// then pairs all 25 together
// so if something odd like 11
// so 11/2= 5 pairs , now we get
// 1 21 , 6 18 , 11 25
// now take 18,18,21
// we get 4 18 , 11 25
// yeah easy ig

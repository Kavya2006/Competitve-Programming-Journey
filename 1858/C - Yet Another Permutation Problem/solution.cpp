...
void Solve(){
ll n; cin>>n;
// for n=3 .. doesnt matter
// n=4 , now 1 wont will have gcd with other two as 1 only
// so try to give 1 prime numbers only
// 1 3 4 2 , here answer will be 2
// N=5 , WE can have gcd max as 1,2 only still
// n=6 , 1,2,3
// n=12 , we can have max n/2=6 which are 1,2,3,4,5,6
// 12,6,3,10,5,8,4,2,1,9
set<ll>s;
for(ll i=n ; i>=1 ; i--){
auto it= s.find(i);
if(it==s.end()){

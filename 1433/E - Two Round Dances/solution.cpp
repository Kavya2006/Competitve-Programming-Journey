...
ll n; cin>>n;
/*
firsrt select n/2 ncn/2 /2!  divide by 2! as n/2 went left can go right as well
now arrangement of n/2 people = (n/2-1)!*(n/2-1)!
eg n=4 , so ncn/2/2! = 3*(1)*1=3
*/
cout<<(nCr_simple(n,n/2)*factorial(n/2-1)*factorial(n/2-1))/2<<endl;
 
}
 
int main() {

...
so a1|a2 , a3| a4 , a5|a6, a7|a8
then (a1|a2)^(a3|a4) , (a5|a6)^(a7|a8)
so at last (a1|a2)^(a3|a4) | (a5|a6)^(a7|a8)
so for a parent i merge its left and right child
and depending on operation it will be or / xor
 
*/
vector<ll>a;
struct Node{

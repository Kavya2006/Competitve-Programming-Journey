...
 
void Solve(){
// seeming like a graph question
// so like if a connected component is cyclic
// then we have to remove part which has highest value
// so it can not interfere later
 
 
ll n,m; cin>>n>>m;
//

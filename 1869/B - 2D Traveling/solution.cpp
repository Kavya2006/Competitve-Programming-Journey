...
int main() {
    ...
    ll mini=10000000000000;
    ll miniature=1000000000000;
    for(int i=0 ; i<k ; i++){
      
      mini = min(mini , abs((x[i]-x[b-1])) +abs((y[i]-y[b-1]))   ) ;
      miniature= min(miniature , abs((x[i]-x[a-1])) +abs((y[i]-y[a-1]))   );
      
    }
    cout<<min(mini+miniature ,abs((x[a-1]-x[b-1])) +abs((y[a-1]-y[b-1])))<<endl;
 
 
    }
 

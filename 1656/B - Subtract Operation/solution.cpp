...
// ------------------------- Main Logic ------------------------- //
/*
so like if we have a1,a2,a3,a4,a5
and we decide to remove a2 we get
a1-a2,a3-a2,a4-a2,a5-a2
now we remove a1 , so now a2 will get added to all numbers
then next number we remove effect of a1 will vanish
so we need to find 2 numbers if there difference is k basically
*/
 
void Solve() {
    ll n,k; 

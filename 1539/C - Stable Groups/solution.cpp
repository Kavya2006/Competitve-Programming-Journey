...
 
// ------------------------- Main Logic ------------------------- //
/* so my idea is saying in another vector i store diff of consec elements
strictly greater than x
then i sort that vector
then i traverse and if possible use these k students so yeah easy ig
 
*/
 
 

...
/*
suppose ax+by=n , here if gcd(a,b)=1 , then largest which we cannot form
is a*b-a-b
// here we have 11 and 111 whose max is 11*111-111-11=1110-11=1099 , after this
we can form all
 
 
*/
...
/* , now can be multiple of 111 or 11 or their combination
linear diophantine
 
*/
if(n%11==0 || n%111==0){
...
// now lets bruteforce rest ig , coz linear diophantine mein might be negative sol
while(n>111){
    n=n-111;
    if(n%11==0){
        cout<<"YES

...
void Solve(){
ll n; cin>>n;
// a0+a1=a1+a2=a0+a1+a2 , so here atleast one element will be zero which aint
// n=4 , ao+a1=a1+a2=a2+a3=a0+a1+a2+a3
// a0=a2 , a1=a3 , a0+a1=0 , 
// so all odd index=1 and even index=-1
// now n=odd so n=5 , ao+a1=a1+a2=a2+a3=a3+a4=a0+a1+a2+a3+a4
// here a0=a2=a4 and a1=a3 , but a0+a1+a2=0 , a0+a3+a4=0
// a0+a1+a4=0  , a2+a3+a4=0/
// so odd indices= -2 times even
// so a1=2*a[0] , let  , a[0]=1 , a[1]=-2
// now suppose 9 elemenets
// 3*a[1]+4*a[0]=0 
//  so a[1]=-4/3*a[0]= a[0]=3 , a[1]=-4
// now 15 so a[1]=-7/6a[0]
// generalising it , a[0]=n/2-1 and a[1]=-(a[0]+1) if odd
 
if(n==3){
    cout<<"NO
";
